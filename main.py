"""Главный модуль для создания персонажа игры."""
...
def attack(char_name: str, char_class: str) -> str:
    ...
    строковое сообщение о проведённой атаке.
    """
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает строковое сообщение о применении специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    В качестве параметров получает введённое игроком имя персонажа и
...
def choice_char_class() -> str:
    """Предлагает игроку выбрать тип игрового персонажа.
    Возвращает выбранный вариант строкового типа.
    """
